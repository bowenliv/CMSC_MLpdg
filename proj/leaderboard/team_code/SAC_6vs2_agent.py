...
import sys
sys.path.append('SAC_AD_6vs2/')

from leaderboard.autoagents import autonomous_agent
from SAC_AD_6vs2.model import SAC_AD
from SAC_AD_6vs2.config import GlobalConfig
from SAC_AD_6vs2.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
