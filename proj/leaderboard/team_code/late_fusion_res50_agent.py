...
import sys
sys.path.append('late_fusion_res50/')

from leaderboard.autoagents import autonomous_agent
from late_fusion_res50.model import LateFusion
from late_fusion_res50.config import GlobalConfig
from late_fusion_res50.data import scale_and_crop_image, transform_2d_points, lidar_to_histogram_features
