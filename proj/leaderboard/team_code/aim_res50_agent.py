...
import sys
sys.path.append('aim_res50/')

from leaderboard.autoagents import autonomous_agent
from aim_res50.model import AIM
from aim_res50.config import GlobalConfig
from aim_res50.data import scale_and_crop_image
...
def get_entry_point():
	return 'AIMRes50Agent'


class AIMRes50Agent(autonomous_agent.AutonomousAgent):
