...
import sys
sys.path.append('SAC_AD_5vs3/')

from leaderboard.autoagents import autonomous_agent
from SAC_AD_5vs3.model import SAC_AD
from SAC_AD_5vs3.config import GlobalConfig
from SAC_AD_5vs3.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
