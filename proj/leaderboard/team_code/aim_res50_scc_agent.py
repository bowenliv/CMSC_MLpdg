...
import sys
sys.path.append('aim_res50_scc/')

from leaderboard.autoagents import autonomous_agent
from aim_res50_scc.model import AIM
from aim_res50_scc.config import GlobalConfig
from aim_res50_scc.data import scale_and_crop_image
...
def get_entry_point():
	return 'AIMRes50SCCAgent'


class AIMRes50SCCAgent(autonomous_agent.AutonomousAgent):
