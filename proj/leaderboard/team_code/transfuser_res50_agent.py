...
import sys
sys.path.append('transfuser_nopre_res50/')

from leaderboard.autoagents import autonomous_agent
from transfuser_nopre_res50.model import TransFuser
from transfuser_nopre_res50.config import GlobalConfig
from transfuser_nopre_res50.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
...
class SAC_ADAgent(autonomous_agent.AutonomousAgent):
	def setup(self, path_to_conf_file):
		...
		self.net = TransFuser(self.config)
