...
import sys
sys.path.append('SAC_AD/')

from leaderboard.autoagents import autonomous_agent
from SAC_AD.model import SAC_AD
from SAC_AD.config import GlobalConfig
from SAC_AD.data import scale_and_crop_image, lidar_to_histogram_features, transform_2d_points
