...
export TEAM_AGENT=leaderboard/team_code/SAC_baseline_agent.py
export TEAM_CONFIG=SAC_AD_baseline/log/SAC-AD-clear
export CHECKPOINT_ENDPOINT=results/SAC_AD_baseline_result.json
