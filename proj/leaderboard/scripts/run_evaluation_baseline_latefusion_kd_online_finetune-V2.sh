...
export TEAM_CONFIG=transfuser-kd-online-finetune/log/transfuser-clear-kd-finetune
export CHECKPOINT_ENDPOINT=results/aim_clear_latefusion_kd_online_finetune_result_v2.json
