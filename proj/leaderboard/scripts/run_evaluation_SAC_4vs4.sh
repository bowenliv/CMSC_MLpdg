...
export TEAM_AGENT=leaderboard/team_code/SAC_4vs4_agent.py
export TEAM_CONFIG=SAC_AD_4vs4/log/SAC-AD-4vs4-clear
export CHECKPOINT_ENDPOINT=results/SAC_AD_4vs4_result.json
