...
export TEAM_AGENT=leaderboard/team_code/late_fusion_res50_agent.py
export TEAM_CONFIG=late_fusion_res50/log/late_fution_res50
export CHECKPOINT_ENDPOINT=results/aim_clear_latefusion_res50_result_V2.json
