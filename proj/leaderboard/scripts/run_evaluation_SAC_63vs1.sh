...
export TEAM_AGENT=leaderboard/team_code/SAC_63vs1_agent.py
export TEAM_CONFIG=SAC_AD_63vs1/log/SAC-AD-7vs1-clear
export CHECKPOINT_ENDPOINT=results/SAC_AD_63vs1_result.json
