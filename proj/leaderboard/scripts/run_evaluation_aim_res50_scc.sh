...
export TEAM_AGENT=leaderboard/team_code/aim_res50_scc_agent.py
export TEAM_CONFIG=aim_res50_scc/log/aim-res50-sac-clear
export CHECKPOINT_ENDPOINT=results/aim_res50_scc_result.json
