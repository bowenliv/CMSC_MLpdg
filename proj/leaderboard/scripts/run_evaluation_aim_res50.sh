...
export TEAM_AGENT=leaderboard/team_code/aim_res50_agent.py
export TEAM_CONFIG=aim_res50/log/aim-res50-clear
export CHECKPOINT_ENDPOINT=results/aim_res50_result.json
