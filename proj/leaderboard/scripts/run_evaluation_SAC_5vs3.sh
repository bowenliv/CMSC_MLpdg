...
export TEAM_AGENT=leaderboard/team_code/SAC_5vs3_agent.py
export TEAM_CONFIG=SAC_AD_5vs3/log/SAC-AD-7vs1-clear
export CHECKPOINT_ENDPOINT=results/SAC_AD_5vs3_result.json
