...
export TEAM_CONFIG=aim-kd-28p-to-100p-ours/log/aim-clear-kd-28p-to-100p-ours-v2
export CHECKPOINT_ENDPOINT=results/aim_clear_latefusion_28p_to_100p_ours_result.json
