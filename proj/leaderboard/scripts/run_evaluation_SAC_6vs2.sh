...
export TEAM_AGENT=leaderboard/team_code/SAC_6vs2_agent.py
export TEAM_CONFIG=SAC_AD_6vs2/log/SAC-AD-7vs1-clear
export CHECKPOINT_ENDPOINT=results/SAC_AD_6vs2_result.json
