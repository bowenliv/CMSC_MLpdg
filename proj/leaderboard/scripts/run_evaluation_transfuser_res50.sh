...
export TEAM_AGENT=leaderboard/team_code/transfuser_res50_agent.py
export TEAM_CONFIG=transfuser_nopre_res50/log/transfuser-nopre-res50--clear
export CHECKPOINT_ENDPOINT=results/transfuser_res50_result_V2.json
